...
<?php
  ...
  include 'connection.php';
	...
	$fechas = array();
	$getFechas = $my_sql_conn->query("select distinct fecha from pedido where materiales!=' ' and fecha>'2015-09-01' and fecha<='2016-09-01'");
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="myMenu">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="materiales.php"><p class="text-center"><img src="img/png/eyeglasses4.png"></p><p class="text-center">Materiales</p></a></li>
