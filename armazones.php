...
<?php
	...
	$fechas = array();
	$getFechas = $my_sql_conn->query("select distinct fecha from pedido where armazon!=' ' and fecha>'2015-09-01' and fecha<='2016-09-01'");
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="myMenu">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="armazones.php"><p class="text-center"><img src="img/png/rectangular35.png"></p><p class="text-center">Armazones</p></a></li>
